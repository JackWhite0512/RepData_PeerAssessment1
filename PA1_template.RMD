...
1. time series plot of the 5-minute interval (x-axis) and the average number
...
4. Histogram of the total number of steps taken each day and calculate and 
...
2. Time series plot averaged across all weekday or weekend days
